;
; Carnivore2+ ROM Dump/IDE Test Utility v1.20
...
dumpBlock_p1:
	...
	ld	a,c
	and	7
	jr	nz,dumpBlock_char1
	
	print	ONE_NL_S
	ld	a,c
	and	0x7f
	jr	nz,dumpBlock_row1
	ret
...
Title:	
	db	13,10
	db	"Carnivore2+ ROM/IDE Dumper v1.20",13,10
	db	"Created by Vladimir & RBSC [2022-2024]",13,10,"$"
SLOTN:	
	db	13,10
...
Choice: db	"Dump ROM or IDE sector (R/S): $"
BLOCKN:
	db	13,10	
	db	"Sector (decimal), Enter or ESC: $"
ROMOFFS:
	db	13,10
	db	"Address (decimal), Enter or ESC: $"
SECT0_ERR:
