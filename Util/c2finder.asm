...
FindCart0:
	...
	jr	FindCart1A
FindCart1:
	print	PORTD			; found Carnivore2
	jr	FindCart111
FindCart11:
	print	PORTD1			; found Carnivore2+
FindCart111:
	ld	a,"S"
	out	(#F0),a			; check port F0
	nop
...
CDetect1:
	...
	jr	CDetect4
CDetect2:
	call	Testslot3		; find Carnivore2+
	jr	nz,CDetect3
	print	SLOTD2			; Carnivore2+ found
	xor	a
	ld	c,a			; zero subslot
	call	CheckFlash		; detect and check FlashROM
	jr	CDetect4
CDetect3:
	print	SLOTND			; No Carnivore1/2/2+ found
	print	ONE_NL_S
CDetect4:
	ld      a,(TPASLOT1)
	ld      h,#40
...
PORTD1:	db	"Carnivore2+ detected in slot $"
EXCLM:	db	"!$"
SLOT1:	db	10,13
