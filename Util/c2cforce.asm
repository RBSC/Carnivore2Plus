;
; Carnivore2/2+ Cartridge's CFG EEPROM Backup Forced Edition
...
DESCR:	db	"CMFC"		; "CMFCCFRC" = Carnivore2
...
PRESENT_S:
	db	3
	db	"Carnivore2/2+ Configuration EEPROM Backup v3.00 Forced Edition",13,10
	db	"(C) 2024 RBSC. All rights reserved",13,10,13,10,"$"
NSFin_S:
	db	"Carnivore2/2+ cartridge was not found. Please specify its slot number - $"
Findcrt_S:
	db	"Found Carnivore2/2+ cartridge in slot(s): $"
M_Wnvc:
	db	10,13,"WARNING!",10,13
	db	"Uninitialized cartridge or wrong version of Carnivore cartridge found!",10,13
	db	"You can still work with this cartridge. Press any key...",10,13,"$"
FindcrI_S:
...
H_PAR_S:
	...
	db	" c2cforce [filename.cbk] [/h] [/v] [/d] [/u]",13,10,13,10
