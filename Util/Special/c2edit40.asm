...
MODE	equ	40		; 80 - default width
				; 40 - MSX1 width, rename the tool to "C2EDIT40.COM"
...
MAIN_S:	db	13,10
	...
	db	" 4 - Optimize directory entries",13,10
	db	" 5 - Init DefConfig directory entry",13,10
	db	" 6 - Show FlashROM's block usage",13,10
	db	" 7 - Restart the computer",13,10
...
H_PAR_S:
	...
	db	" c2edit [filename.rom] [/h] [/v] [/a] [/r]",13,10,13,10
	...
	db	" /su - enable Super User mode (editing all registers)",10,13,"$"
;------------------ MODE 80 ------------------
   else
;------------------ MODE 40 ------------------
PRESENT_S:
...
H_PAR_S:
	db	"Usage:",13,10,13,10
	db	" c2edit40 [file.rom] [/h] [/v] [/a] [/r]",13,10,13,10
	db	"Command line options:",13,10
	db	" /h  - this help screen",13,10
	...
	db	"       (editing all registers)",10,13,"$"
;------------------ MODE 40 ------------------
   endif
...
NOTE:	db	"NOTE:",10,13
	...
	db	"use the C2EDIT40.COM utility instead.",10,13
...
;
; Common strings for both C2EDIT and C2EDIT40 utilities
;
