...
STTEST:
	db	"Starting $"
STTEST1:
	db	" iterations test on disk "
STTEST2:
	db	"A:...",10,13
	db	"Hold ESC key to stop.",10,13,10,13,"$"
STTEST3:
	db	" iterations test on default disk...",10,13
	db	"Hold ESC key to stop.",10,13,10,13,"$"
...
FLAGS:
	db	"Usage:",13,10
	db	" C2DSKTST [/?] [/N] [Disk]",13,10
	db	"  where 'N' = number of iterations: 2-99",13,10
	db	"  and 'Disk' = disk drive letter A-Z",13,10
	db	"  or '?' = show help",13,10,13,10
	db	" Examples:",13,10
	db	"  C2DSKTST /25 A",13,10
	db	"  C2DSKTST /?",13,10,13,10,"$"
